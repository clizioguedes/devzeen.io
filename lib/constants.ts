...
export const projects: Project[] = [
  {
    ...
    longDescription:
      "Produto SaaS completo de gestão industrial desenvolvido para automatizar e otimizar processos de fábricas de confecção. Inclui controle de produção, estoque, vendas, financeiro e relatórios gerenciais. Arquitetura escalável com Next.js e Node.js.",
  ...
  },
  {
    ...
    longDescription:
      "Aplicação mobile-first para fãs do Cartola FC. Produto independente que permite criar escalações estratégicas, acompanhar parciais em tempo real, comparar desempenho com outros cartoleiros e receber notificações de valorização. Interface intuitiva e responsiva com React.",
  ...
  },
  {
    ...
    technologies: ["Next.js", "TypeScript", "Node.js", "AWS S3"],
    category: ["Next.js", "TypeScript", "Node.js"],
    githubUrl: "https://github.com/clizioguedes",
    featured: true,
  },
